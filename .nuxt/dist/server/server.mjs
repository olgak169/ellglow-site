...
const servicesPage = {
  main: [
    ...
    },
    {
      ...
      name: "Facial massage",
      process: [
        "Gentle cleansing, application of nourishing massage oil, a series of specialized massage techniques targeting the face, neck, and décolletage, lymphatic drainage movements, and application of finishing products to nourish and protect the skin."
      ],
